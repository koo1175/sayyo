        ...
        <div
            ...
            >
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '18px', marginTop:'2%', marginLeft:'50%', width:'760px'}}>
                    ...
                    <div className='subNav' style={{ flexBasis: '16%' }} onMouseEnter={(e) => e.target.style.color = 'blue'} onMouseLeave={(e) => e.target.style.color = 'black'} onClick={gotoAboutUs}>
                        공지사항
                    </div>
                    <div className='subNav' style={{ flexBasis: '16%' }} onMouseEnter={(e) => e.target.style.color = 'blue'} onMouseLeave={(e) => e.target.style.color = 'black'}>
                        About Us
                    </div>
                    <div className='subNav' style={{ flexBasis: '16%' }} onMouseEnter={(e) => e.target.style.color = 'blue'} onMouseLeave={(e) => e.target.style.color = 'black'} onClick={gotoMyPage}>
                        고객센터
                    </div>
                </div>
            </div>
